...
import ELearningPlans from '../components/ELearningPlans.vue';
...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        path:
          ':settingType(semester-one-start|semester-one-end|semester-two-start|semester-two-end)',
        component: YearSetting,
        props: true,
      },
      {
        path: 'elearning',
        component: ELearningPlans,
        props: true,
      },
    ],
  },
